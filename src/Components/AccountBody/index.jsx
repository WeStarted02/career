        ...
        <div>
           ...
           <div className='col-1'>
                <div style={bgColor == "black" ? {background:"#333"} : {background:"#d9d9d9"}}>
                    ...
                    <button style={bgColor == "black" ? {background:"#d9d9d9"} : {background:"#fff"}} className='btn-elon'>E'lonlar</button>
                </div>
            </div>
            <div className='col-2'>
                <div style={bgColor == "black" ? {background:"#333"} : {background:"#d9d9d9"}} className=''>
                    <h2 style={{color}}>Kechmishim</h2>
                    <button style={bgColor == "black" ? {background:"#d9d9d9"} : {background:"#fff"}} className='btn-add'>Qo'shish</button>
                    <p className='ochiqlama'>Bu bo’limda kechmish ish hayotingizni tariflovchi fayl cv’lari yuklang </p>
                    <div style={bgColor == "black" ? {background:"#d9d9d9"} : {background:"#fff"}} className='div-file'>
                        <p>25.02.1099</p>
                        <p className='ochiqlama'>Yuklagan ajoyib CV’laringiz bilan ish e’lonlariga topshiring</p>
                        <button>E'lonlar</button>
                    </div>
                    <button style={bgColor == "black" ? {background:"#d9d9d9"} : {background:"#fff"}} className='mt-2'>Barcha CV'lar</button>
                </div>
                ...
                <div style={bgColor == "black" ? {background:"#333"} : {background:"#d9d9d9"}}>
                    ...
                    <div>
                        <ul>
                            <li>
                                <div style={bgColor == "black" ? {background:"#d9d9d9"} : {background:"#fff"}} className='li-div'>
                                    <p>25.02.1099</p>
                    ...
                    <button style={bgColor == "black" ? {background:"#d9d9d9"} : {background:"#fff"}} className='mt-1'>Barcha CV'lar</button>
                </div>
            </div>
           </div>
        </div>
