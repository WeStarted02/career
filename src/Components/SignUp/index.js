            ...
            <div className="rounded-4 card" >
                <div className="card rounded-4 " >
                    <div className="">
                        ...
                        <input type="text" className="form-control " onChange={e => setFullname(e.target.value)} id="fullnameInput" placeholder="Enter your fullname" />
                    </div>

                    <div className="">
                        <label className="form-label" >Username*</label>
                        <input type="text" className="form-control " onChange={e => setUsername(e.target.value)} id="usernameInput" placeholder="Enter your username" />
                    </div>
